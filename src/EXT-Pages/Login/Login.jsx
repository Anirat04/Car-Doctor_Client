                ...
                <div className="hero-content flex-col gap-[70px] lg:flex-row">
                    ...
                    <div className="card flex-shrink-0 p-[75px] border">
                        <div className="w-full text-gray-100">
                            <h1 className="text-[40px] font-semibold text-[#444444] text-center mb-[50px]">Login</h1>
                            <form className="space-y-6 w-[461px]">
                                ...
                                <button className="block w-full p-3 text-center text-white rounded-lg bg-[#FF3811]">Sign in</button>
                            </form>
                            <div className="flex items-center pt-4 space-x-1 mt-[2-px]">
                                <div className="flex-1 h-px sm:w-16 bg-gray-700"></div>
                                <p className="px-3 text-[18px] text-[#444444] font-medium">Or Sign In with</p>
                                <div className="flex-1 h-px sm:w-16 bg-gray-700"></div>
                            </div>
